...
<html>
    <head>
        <title>Rusty's Tools - TeamMix</title>
        <?php include $templatedir."head/cssfiles.phtml"; ?>
    </head>
    <body>
        <?php
            $additionalNavItems = "<li class='nav-item'><a class='nav-link' href='".$baseurl."'>Home</a></li>";
            $additionalNavItems .= "<li class='nav-item active'><a class='nav-link' href='".$baseurl.$toolname."'>TeamMix <span class='sr-only'>(current)</span></a></li>"
        ?>
